        ...
        <Swiper {...slider} className="swiper banner3-slider">
            ...
            <SwiperSlide className="swiper-slide">
                ...
                <div className="banner-content">
                    <h1>adaptive
to your business, your growth & the future.</h1>
                    <p>Proudly serving the world's top asset finance & leasing companies with smart software technology for over four decades.
</p>
