      ...
      <div className="col-lg-4 col-sm-6 d-flex">
        <div className="footer-widget">
          <div className="footer-contact mb-40">
            ...
            <a href="#">Encino +1 818 222 9195<br/>
...
Lahore +92 42 111 44 88 00</a>
          ...
          <div className="footer-contact mb-40">
            ...
            <a href="mailto:ifo@example.com">info@netsoltech.com</a><br />
          </div>
      ...
      <div className="col-lg-3 col-sm-6 d-flex justify-content-lg-start justify-content-sm-end">
        <div className="footer-widget">
          ...
          <div className="menu-container">
            <ul>
              <li><Link legacyBehavior href="/service"><a>NFS Ascent</a></Link></li>
              <li><Link legacyBehavior href="/service2"><a>NFS Digital</a></Link></li>
            </ul>
          </div>
        </div>
      </div>
